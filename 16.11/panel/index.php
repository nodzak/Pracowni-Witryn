    ...
    <div class="container py-5">
        ...
        <div class="row mb-3">
            <div class="col-12">
                ...
                <input type="radio" class="btn-check" name="display-style" id="style-table" autocomplete="off" value="<?= DisplayStyle::Table->value ?>" <?= $cookieValue === DisplayStyle::Table->value ? 'checked' : '' ?>>
<label for="style-table" class="btn btn-outline-primary">Table</label>


                   

<input type="radio" class="btn-check" name="display-style" id="style-grid" autocomplete="off" value="<?= DisplayStyle::Grid->value ?>" <?= $cookieValue === DisplayStyle::Grid->value ? 'checked' : '' ?>>
