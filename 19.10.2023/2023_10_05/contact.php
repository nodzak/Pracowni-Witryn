...
if(isset($_GET['error'])) {
    ...
    switch ($error) {
        ...
        case'2':
            ...
            break;
        case'3':
            $errorMessage = "Wiadomości musi mieć minimum 20 znaków";
            break;
        case'4':
            $errorMessage = "Podobno niepoprawny adres e-mail";
            break;
    }
}

// $errorMessage - match($error) {
    // '1' => 'W farmularzu brakuje danych',
    // '2' => 'Adres e-mail i/lub treść wiadomości nie mogą być puste',
    // '3' => "Wiadomości musi mieć minimum 20 znaków",
    // '4' => "Podobno niepoprawny adres e-mail",
    // default => null
